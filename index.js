...
class DailyCallManager {
    constructor() {
      this.call = Daily.createCallObject(); /** This is the call client */
    ...
    setupEventListeners() {
      const events = {
        'active-speaker-change': this.handleActiveSpeakerChange.bind(this), /**this will help us trigger the wave animation **/
